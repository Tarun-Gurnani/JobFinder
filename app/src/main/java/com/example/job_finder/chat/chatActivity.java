package com.example.job_finder.chat;
...
import com.example.job_finder.Matches.MatchesActivity;
import com.example.job_finder.R;
import com.example.job_finder.SendNotification;
...
public class chatActivity extends AppCompatActivity {
    ...
    private String lastMessage, lastTimeStamp, message, createdByUser, isSeen, messageId, currentUserName;
    ...
    public void showProfile(View v){
        ...
        }else if(matchNeed.equals ( "Youtube orignals" )){
    ...
    public boolean onOptionsItemSelected ( @NonNull MenuItem item ) {
        if(item.getItemId () == R.id.ummatch){
            new AlertDialog.Builder ( chatActivity.this )
                    .setTitle ( "Unmatch" )
                    .setMessage ( "Are you sure you want to ummatch ?" )
                    .setPositiveButton ( "Ummatch" , new DialogInterface.OnClickListener ( ) {
                        @Override
                        public void onClick ( DialogInterface dialogInterface , int i ) {
                            ...
                            finish ();
                            Toast.makeText ( chatActivity.this, "Ummatch successful", Toast.LENGTH_SHORT ).show ();
                        }
                    } )
